...
const [typeEffect] = useTypewriter({
  ...
  return (
    <div>
      <div className={`relative h-[calc(100vh-3.5rem)] w-full xs:bg-p_mobile xs:bg-cover  bg-no-repeat md:bg-portfolio  lg:bg-cover bg-fixed   `}>
        ...
        <div className='md:absolute md:top-[50%] md:left-[10%] xs:absolute xs:top-[22%] xs:left-[25%]   md:-translate-y-[50%] font-bold '><h1 className='md:text-8xl xs:text-7xl font-rohit text-yellow-500'>Rohit <br /> Kumar</h1><span className='md:text-6xl xs:text-5xl font-designation text-red-500'>{typeEffect}</span></div>
